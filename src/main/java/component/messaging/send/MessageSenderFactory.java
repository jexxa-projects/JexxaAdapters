package component.messaging.send;

import component.messaging.send.jms.JMSSender;
import component.messaging.send.logging.MessageLogger;
...
import static wrapper.jms.JMSProperties.JNDI_FACTORY_KEY;

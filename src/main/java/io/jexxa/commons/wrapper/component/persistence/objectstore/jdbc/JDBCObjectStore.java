package io.jexxa.commons.wrapper.component.persistence.objectstore.jdbc;
...
import io.jexxa.commons.wrapper.jdbc.JDBCProperties;
import io.jexxa.commons.wrapper.jdbc.builder.JDBCObject;
import io.jexxa.commons.wrapper.jdbc.builder.SQLDataType;
import io.jexxa.commons.wrapper.jdbc.database.DatabaseManager;
import io.jexxa.commons.wrapper.jdbc.database.IDatabase;
...
import static io.jexxa.commons.wrapper.jdbc.builder.JDBCTableBuilder.SQLConstraint.PRIMARY_KEY;
import static io.jexxa.commons.wrapper.jdbc.builder.SQLDataType.JSONB;
import static io.jexxa.commons.wrapper.jdbc.builder.SQLDataType.NUMERIC;
import static io.jexxa.commons.wrapper.jdbc.builder.SQLDataType.TEXT;

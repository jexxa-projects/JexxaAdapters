package io.jexxa.commons.adapter.persistence.objectstore.imdb;



import io.jexxa.commons.adapter.persistence.objectstore.INumericQuery;
import io.jexxa.commons.adapter.persistence.objectstore.metadata.StringTag;
import io.jexxa.commons.adapter.persistence.objectstore.IObjectStore;
import io.jexxa.commons.adapter.persistence.objectstore.IStringQuery;
import io.jexxa.commons.adapter.persistence.objectstore.metadata.MetadataSchema;
import io.jexxa.commons.adapter.persistence.objectstore.metadata.NumericTag;

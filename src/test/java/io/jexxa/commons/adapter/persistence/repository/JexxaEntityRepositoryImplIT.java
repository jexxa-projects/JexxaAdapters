package io.jexxa.commons.adapter.persistence.repository;
...
import io.jexxa.commons.facade.jdbc.JDBCTestDatabase;
...
import static io.jexxa.commons.adapter.persistence.RepositoryManager.getRepository;
...
class JexxaEntityRepositoryImplIT
{
    ...
    void addAggregate(Properties repositoryProperties)
    {
        ...
        var objectUnderTest = getRepository(JexxaEntity.class, JexxaEntity::getKey, repositoryProperties);
